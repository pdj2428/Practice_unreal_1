...
AMain::AMain()
{
	...
	// Create Camera Boom (Puuls towards the player if there's a collision)
	...
	GetCharacterMovement()->RotationRate = FRotator(0.0f, 840.f, 0.0f); // ...at this rotatipn rate
...
void AMain::TakeDamage(float DamageAmount, AEnemy* Enemy)
{
...
void AMain::UpdateCombatTarget()
{
	...
	GetOverlappingActors(OverlappingActors, EnemyFileter);
